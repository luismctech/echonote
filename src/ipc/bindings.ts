 ...
 */
async pauseStreaming(sessionId: StreamingSessionId) : Promise<Result<boolean, IpcError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("pause_streaming", { sessionId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async resumeStreaming(sessionId: StreamingSessionId) : Promise<Result<boolean, IpcError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("resume_streaming", { sessionId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async getMeetingId(sessionId: StreamingSessionId) : Promise<Result<MeetingId | null, IpcError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_meeting_id", { sessionId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async renameMeeting(id: MeetingId, title: string) : Promise<Result<MeetingSummary, IpcError>> {
    try {
 ...
 */
async addNote(meetingId: MeetingId, text: string, timestampMs: number) : Promise<Result<Note, IpcError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("add_note", { meetingId, text, timestampMs }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async listNotes(meetingId: MeetingId) : Promise<Result<Note[], IpcError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("list_notes", { meetingId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async deleteNote(noteId: NoteId) : Promise<Result<boolean, IpcError>> {
    try {
 ...
 */
async unloadModel(kind: string) : Promise<Result<boolean, IpcError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("unload_model", { kind }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async setActiveEmbedder(modelId: string) : Promise<Result<null, IpcError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_active_embedder", { modelId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async getActiveEmbedder() : Promise<string | null> {
    return await TAURI_INVOKE("get_active_embedder");
},
/**
...
async getModelRecommendation() : Promise<ModelRecommendation> {
    return await TAURI_INVOKE("get_model_recommendation");
},
/**
 * Detect all known MCP clients and their installation status.
 */
async detectMcpClients() : Promise<McpClient[]> {
    return await TAURI_INVOKE("detect_mcp_clients");
},
/**
 * Install the EchoNote MCP server entry into a specific client's config.
 */
async installMcpClient(clientId: string) : Promise<Result<McpInstallResult, IpcError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("install_mcp_client", { clientId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async uninstallMcpClient(clientId: string) : Promise<Result<McpInstallResult, IpcError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("uninstall_mcp_client", { clientId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async getMcpConfigSnippet() : Promise<string> {
    return await TAURI_INVOKE("get_mcp_config_snippet");
}
}
 ...
 */
export type McpInstallResult = { success: boolean; message: string }
/**
 ...
 */
{ type: "resumed"; sessionId: StreamingSessionId }
